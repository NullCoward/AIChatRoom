...
class TestConfigConstants(unittest.TestCase):
    ...
    def test_attention_percentages(self):
        ...
        self.assertIsInstance(config.DEFAULT_ATTENTION_PCT, float)
        self.assertIsInstance(config.SELF_ROOM_ATTENTION_PCT, float)

        # Self room should get significant attention
        self.assertGreaterEqual(config.SELF_ROOM_ATTENTION_PCT, 50.0)
...
class TestConfigValidation(unittest.TestCase):
    ...
    def test_all_config_values_accessible(self):
        ...
        expected_attrs = [
            ...
            'DEFAULT_TEMPERATURE',
            'DEFAULT_ROOM_WPM',
            'DEFAULT_ATTENTION_PCT',
            'SELF_ROOM_ATTENTION_PCT',
            'MIN_WPM',
            'MAX_WPM',
            'API_TIMEOUT_SECONDS',
    ...
    def test_config_types_correct(self):
        ...
        # Floats
        float_attrs = [
            'DEFAULT_TEMPERATURE', 'DEFAULT_ATTENTION_PCT',
            'SELF_ROOM_ATTENTION_PCT', 'SHARED_ATTENTION_PCT'
        ]
