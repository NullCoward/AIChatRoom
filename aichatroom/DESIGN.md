...
### ChatroomService (`services/chatroom_service.py`)

Main application coordinator:

- Initializes The Architect on first run
- Manages agent lifecycle
- Routes messages to rooms
- Handles rate limiting (WPM/RPM)
...
rooms           -- Legacy table (rooms are now agents)
```
...
# Attention
DEFAULT_ATTENTION_PCT = 10.0
SELF_ROOM_ATTENTION_PCT = 100.0
SHARED_ATTENTION_PCT = 50.0
